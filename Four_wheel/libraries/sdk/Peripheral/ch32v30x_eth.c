...
* Input          : ETH_MMC_IT: specifies the ETHERNET MMC interrupt.
*                  ETH_MMC_IT_TxFomC: When Tx good frame counter reaches half the maximum value.
*                  ETH_MMC_IT_TxMomC: When Tx good multi col counter reaches half the maximum value.
*                  ETH_MMC_IT_TxSomC: When Tx good single col counter reaches half the maximum value .
